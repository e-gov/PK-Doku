...
permalink: /11-Haldusliidese-REST-API-d/
---
...
Kui liidestujal on vaja visuaalselt seostada template-, system- ja notification-management teenuseid, on täiendav kõrgtaseme skeem toodud peatükis [Skeemid ja joonised](../12-Skeemid-ja-joonised/).
